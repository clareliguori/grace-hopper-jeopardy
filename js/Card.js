...
class Card extends React.Component {
    ...
    render() {
        let style = {
            ...
            front = this.state.completed ? <img src='assets/img/Grace-Hopper.svg'/> : <span className='points'>{this.props.question.points}</span>,
            className = 'flipper';
            ...
            <div style={style} className={className} onClick={this.clickHandler.bind(this)} onTransitionEnd={this.transitionEndHandler.bind(this)}>
                <div className='card'>
                    ...
                    <div className='back'>
                        ...
                        <img src='assets/img/Grace-Hopper.svg'/>
                    </div>
                </div>
            </div>
        );
